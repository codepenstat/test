2 раза вводить пароль 

<?php

$hashed_password = '179ad45c6ce2cb97cf1029e212046e81'; // testpass
if (isset($_POST['password']) && md5($_POST['password']) === $hashed_password) {
    setcookie('authorized', true, time() + 86400);
}
	...
	<nav>
       <div class="container">
	    <div class="nav-wrapper">
	      <a href="#" class="brand-logo center">Day</a>
	    </div>
	   </div>
  	</nav>
